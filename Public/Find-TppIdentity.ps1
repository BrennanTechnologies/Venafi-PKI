...
.EXAMPLE
Find-TppIdentity -Name 'chris' -IncludeUsers
Find only user identities with the name chris

.EXAMPLE
'chris', 'brennan' | Find-TppIdentity
Find all identity types with the name chris and brennan
